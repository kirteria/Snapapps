...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    p.sub { color: #666; font-size: 0.85rem; margin-bottom: 3rem; }
    .grid { display: flex; flex-direction: column; gap: 1rem; width: 100%; max-width: 400px; }
    .card { border: 1px solid #2a2a2a; border-radius: 12px; padding: 1.25rem 1.5rem; background: #111; text-decoration: none; color: inherit; display: flex; align-items: center; gap: 1rem; transition: border-color 0.2s, background 0.2s; }
